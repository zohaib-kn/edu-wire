...
export const hungaryData: MBBSCountry = {
  ...
  keyPoints: [
    ...
    "Some Hungarian universities may conduct entrance exams or interviews in Biology, Chemistry, and English."
  ],
  universities: [
  ...
  heroBgImage: "/images/mbbs/hungary/hero/hero-bg.webp",
  ...
  aboutImage: "/images/mbbs/hungary/about/about-img.jpg",
  aboutParagraphs: [
  ...
  universitiesDetailed: [
    {
      ...
      image: "/images/mbbs/hungary/universities/uni-1.webp",
      badges: [
        "Public University",
        "Founded 1367",
        "Pécs, Hungary"
    ...
    },
    {
      ...
      image: "/images/mbbs/hungary/universities/uni-2.webp",
      badges: [
        "Public University",
        "Oldest Institute",
        "Debrecen, Hungary"
    ...
    },
    {
      ...
      image: "/images/mbbs/hungary/universities/uni-3.webp",
      badges: [
        "Founded 1769",
    ...
    },
    {
      ...
      image: "/images/mbbs/hungary/universities/uni-4.jpg",
      badges: [
        "Public University",
        "Founded 1581",
        "Szeged, Hungary"
  ...
  eligibilityDetailed: {
    ...
    criteria: [
      ...
      "NEET qualification is mandatory for Indian students as per NMC guidelines.",
      "Some Hungarian universities may conduct entrance exams or interviews in Biology, Chemistry, and English.",
      "English language proficiency may be required (IELTS/TOEFL), depending on the university."
    ],
    entranceTest: {
    ...
    steps: [
      {
        ...
        detailedContent: [
          ...
          },
          {
            ...
            items: [
              "Mandatory entrance tests for most universities: o Biology, Chemistry, Physics (written/oral) o Some universities conduct online interviews",
        ...
        detailedContent: [
          ...
          },
          {
            ...
            items: [
              ...
              "o Laptop with EU power adapter (Type F, 230V).",
  ...
  faqs: [
    ...
    {
      question: "How much are the living expenses for students in Hungary?+",
